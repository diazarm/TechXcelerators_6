...
export const DocumentTableRow: React.FC<DocumentTableRowProps> = ({
  ...
  return (
    <div 
      className="bg-white border-b border-gray-100 hover:bg-gray-50 transition-colors items-center w-full grid"
      style={{ 
    ...
    >
      ...
      <div
        ...
        className="font-medium text-gray-900 truncate cursor-pointer hover:text-[#FF6E00]"
      ...
      <div className="flex">
        <span 
          className="inline-flex rounded-full bg-yellow-50 text-yellow-800 font-medium whitespace-nowrap"
          style={{ 
      ...
      >
        {isAdmin ? (
          ...
          >
            {getRoleLabels(document.visibleTo)}
          </span>
        )}
      </div>
      ...
      >
        ...
        <div 
          ...
          title="Ver documento"
        >
          <Download size={scale(16)} className="text-[#5D5A88] hover:text-[#FF6E00] transition-colors" />
          <span 
            className="text-gray-500 whitespace-nowrap hidden xl:inline"
            style={{ fontSize: scale(12) }}
          >
            Ver
          </span>
        ...
        {isAdmin && onEdit && (
          ...
          >
            <Edit3 size={scale(16)} className="text-[#5D5A88] hover:text-[#FF6E00] transition-colors" />
            <span 
              className="text-gray-500 whitespace-nowrap hidden xl:inline"
              style={{ fontSize: scale(12) }}
            >
